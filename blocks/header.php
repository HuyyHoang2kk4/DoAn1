...
<body>
    ...
    <div class="w3-container " style="padding: 0px;">
        <div class="w3-row" style="height: 35px;">
            ...
            <div class="w3-col m5">
                <div class="w3-col m8">
                    <a href="index.php"><img src="img/logoo.gif" alt="" style=" width:100px;height:45px;margin:10px 0px 0px 240px"></a>
                </div>
                    ...
                    <div class="w3-col m6">
                        <div class="w3-row">
                            ...
                            <div class="w3-col m6" style="margin: 10px 0px 0px 0px;">
                                ...
                                ?>
                                    <p style="font-size:12px;margin:7px 0px 7px 0px">Người dùng : <?php echo $_SESSION["ten_dangnhap"]; ?></p>
                                <?php
                                } else {
                                ?>
